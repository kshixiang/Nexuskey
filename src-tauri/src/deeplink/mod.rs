//! Deep link import functionality for NexusKey
//!
//! This module implements the nexuskey:// protocol for importing configurations
...
///
/// Represents a parsed nexuskey:// URL ready for processing.
