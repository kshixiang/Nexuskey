...
//!
//! Parses nexuskey:// URLs into DeepLinkImportRequest structures.
...
/// Parse a nexuskey:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// nexuskey://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != crate::app_identity::APP_DEEPLINK_SCHEME
        && scheme != crate::app_identity::LEGACY_DEEPLINK_SCHEME
    {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected '{}' or '{}', got '{scheme}'",
            crate::app_identity::APP_DEEPLINK_SCHEME,
            crate::app_identity::LEGACY_DEEPLINK_SCHEME
        )));
    }
